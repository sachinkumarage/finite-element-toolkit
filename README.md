...
- **Version 21** — Advanced thermal boundary conditions and coupled thermomechanics: convection (Newton cooling) boundary conditions, surface heat transfer, radiation, nonlinear thermal boundary conditions, stronger thermal-mechanical coupling, temperature-dependent mechanical properties evaluated during the analysis itself, and an improved multiphysics workflow building directly on Version 20's thermal foundation
