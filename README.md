...
│   │                       # (Version 23 FEAViewer integration); components.py;
│   │                       # workflow_pages/ (Project, Material, Mesh,
│   │                       # Boundary Conditions, Loads, Solver, Run, Results,
│   │                       # 3D Visualization -- one module per page)
...
- **Version 25** — Advanced meshing and engineering model preparation: improved mesh generation, mesh-quality metrics and refinement, element-quality visualization, a geometry-to-mesh workflow, mesh repair/validation, improved engineering model preparation, and GUI-based mesh controls, building directly on Version 24's GUI and Version 8's mesh-generation foundation
