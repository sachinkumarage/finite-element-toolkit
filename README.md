...
- **Version 23** — Advanced 3D visualization and an interactive FEA viewer: an interactive 3D mesh viewer, PyVista-based visualization, 3D temperature/stress contours, vector fields, deformed-mesh visualization, animation of load/time steps, interactive result selection, and engineering-oriented visualization controls, building directly on Version 22's post-processing framework
