...
and results). Version 4 extends the same workflow to 2D pin-jointed truss
...
constraints, displacements, reactions, and member forces.

The toolkit does not yet implement beam, frame, plate, shell, 2D
continuum, or 3D elements, nonlinear or dynamic analysis, or
visualization.
"""
